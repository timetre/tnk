...
<div class="scroll-pane products_block">
	<div style="width: {sizeof($products)*245+225}px;">
		<table id="product_comparison">
			...
			{foreach from=$products item=product name=for_products}
				...
				<td style="width:245px" class="ajax_block_product comparison_infos">
					...
					<h3><a href="{$product->getLink()}" title="{$product->name|truncate:32:'...'|escape:'htmlall':'UTF-8'}">{$product->name|truncate:27:'...'|escape:'htmlall':'UTF-8'}</a></h3>
					...
					<div class="product_desc"><a href="{$product->getLink()}" title="{l s='More'}">{$product->description_short|strip_tags|truncate:70:'...'}</a></div>
