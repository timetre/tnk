<?php /* Smarty version Smarty-3.1.8, created on 2013-10-27 15:54:38
         compiled from "/Applications/MAMP/htdocs/tnk/web/store/themes/et_urbanista/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2062518012526d292e38b0b9-88769676%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eea78f2b3c3164f372ecf9340c5b0efccc07dfe7' => 
    array (
      0 => '/Applications/MAMP/htdocs/tnk/web/store/themes/et_urbanista/product.tpl',
      1 => 1382869019,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2062518012526d292e38b0b9-88769676',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526d292f8143b1_69523620',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526d292f8143b1_69523620')) {function content_526d292f8143b1_69523620($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/tnk/web/store/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_date_format')) include '/Applications/MAMP/htdocs/tnk/web/store/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/Applications/MAMP/htdocs/tnk/web/store/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/Applications/MAMP/htdocs/tnk/web/store/tools/smarty/plugins/function.counter.php';
?>
...
icon/cancel_11x13.gif" width="11" height="13"/> <a id="resetImages" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['product']->value);?>
...
<?php }?>
	...
	<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0){?><span class="outofstock"><?php echo smartyTranslate(array('s'=>'Out of stock'),$_smarty_tpl);?>
</span><?php }else{ ?><span class="availability"><?php echo smartyTranslate(array('s'=>'Available'),$_smarty_tpl);?>
</span><?php }?>
...
<?php }?></span> <?php echo smartyTranslate(array('s'=>'for green tax'),$_smarty_tpl);?>
 ...
 <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->unity, 'htmlall', 'UTF-8');?>
			...
			<?php }?>
			<p id="reduction_percent" <?php if (!$_smarty_tpl->tpl_vars['product']->value->specificPrice||$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']!='percentage'){?> style="display:none;"<?php }?>> <?php echo smartyTranslate(array('s'=>'(price reduced by'),$_smarty_tpl);?>
...
%<?php }?> </span> <?php echo smartyTranslate(array('s'=>')'),$_smarty_tpl);?>
 </p>
			<p id="reduction_amount" <?php if (!$_smarty_tpl->tpl_vars['product']->value->specificPrice||$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']!='amount'&&intval($_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])==0){?> style="display:none"<?php }?>> <?php echo smartyTranslate(array('s'=>'(price reduced by'),$_smarty_tpl);?>
