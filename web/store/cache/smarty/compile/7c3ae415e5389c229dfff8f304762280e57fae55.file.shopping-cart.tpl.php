<?php /* Smarty version Smarty-3.1.8, created on 2013-10-08 20:29:05
         compiled from "/homez.151/thenailk/www/themes/et_urbanista/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:31033792051162f0838c7c6-98397034%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7c3ae415e5389c229dfff8f304762280e57fae55' => 
    array (
      0 => '/homez.151/thenailk/www/themes/et_urbanista/shopping-cart.tpl',
      1 => 1381256943,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31033792051162f0838c7c6-98397034',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_51162f08ece047_19696514',
  'variables' => 
  array (
    'account_created' => 0,
    'empty' => 0,
...
<?php if ($_valid && !is_callable('content_51162f08ece047_19696514')) {function content_51162f08ece047_19696514($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/homez.151/thenailk/www/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php if (1==2&&isset($_smarty_tpl->tpl_vars['lastProductAdded']->value)&&$_smarty_tpl->tpl_vars['lastProductAdded']->value){?>
...
" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['lastProductAdded']->value['name'], 'htmlall', 'UTF-8');?>
...
<?php }?>
		<br class="clear" />
<p class="your_shopping"><?php echo smartyTranslate(array('s'=>'Your shopping cart contains:'),$_smarty_tpl);?>
	...
	<table id="cart_summary" class="std">
		<thead>
			<tr>
				...
				<th style="display:none;" class="cart_ref item"><?php echo smartyTranslate(array('s'=>'Ref.'),$_smarty_tpl);?>
</th>
...
<?php }?></td>
			...
			<?php }?>
		<?php }else{ ?>
			<tr style="display:none;" class="cart_total_price">
...
<?php }?></td>
			...
			<tr style="display:none;" class="cart_total_tax">
			...
			<tr class="cart_total_price total_font">				
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
